...
public class OvalShape extends Shape{
    ...
    public boolean contains(Point p) {
        ...
        Ellipse2D outer = new Ellipse2D.Float(x - 3, y - 3, 
            width + 6, height + 6);
        Ellipse2D inner = new Ellipse2D.Float(x + 2, y + 2, 
            width - 4, height - 4);
